package top.yanquithor.zzxj.command;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.arguments.StringArgumentType;
import net.minecraft.commands.CommandSourceStack;
import net.minecraft.commands.Commands;
import top.yanquithor.zzxj.command.subcommand.HelpCommand;
import top.yanquithor.zzxj.command.subcommand.StageCommand;
import top.yanquithor.zzxj.command.subcommand.Subcommand;
...
public class HHQGCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("zzxj")
